output "composer_env_name" {
  value       = google_composer_environment.create_composer_env.name
  description = "Name of the Cloud Composer Environment."
}

output "composer_env_id" {
  value       = google_composer_environment.create_composer_env.id
...
output "airflow_uri" {
  value       = google_composer_environment.create_composer_env.config.0.airflow_uri
  description = "URI of the Apache Airflow Web UI hosted within the Cloud Composer Environment."
}

output "gke_cluster" {
  value       = google_composer_environment.create_composer_env.config.0.gke_cluster
